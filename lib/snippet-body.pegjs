...
// Two kinds of format string conditional syntax: VSCode's version and
// TextMate's version.
//
// VSCode's is easier to parse because the if-result and else-result can only
// be plain text, as per the specification.
//
// TextMate's is more powerful, but also harder to parse, because it can
// contain special flags and regex backreferences.
